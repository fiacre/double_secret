...
leaving print statement in as they do no harm
in a real world web app, would prefer logging
also, as a web app, signal handler for interupts 
won't fly -- comment that out
fix minor 2.7 to 3.5 error, open(state file, 'wb') to
pickle state
"""
...
class Annealer(object):
    ...
    def auto(self, minutes, steps=2000):
        ...
        # probability is math.exp( -abs(next_score-prev_score)/temperature )
